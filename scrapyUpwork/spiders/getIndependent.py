...
class IndepentSpider(scrapy.Spider):
    ...
    def start_requests(self):
        for url in self.urls:
            ...
            yield Request(url = url, cookies = self.cookies, callback = self.parse, headers=self.headers)
        # return [Request(url = self.url, cookies = self.cookies, headers=self.headers)]
